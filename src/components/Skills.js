...
const Skills=()=>{return(<div className='skills'><h2 className='py-5'>My Skills</h2><div className='container'><div className='row'><div className='col-lg-4 col-md-4 col-sm-6'><div className='box'><div className='circle'><FontAwesomeIcon icon={faCloud}className='icon' size='2x'/></div><h3>Cloud Integration</h3><div class='list-group'><button
type='button'
